...
idle_xml_name = 'BG-BF-IDLE0'
left_xml_name = 'BG-BF-LEFT0'
down_xml_name = 'BG-BF-DOWN0'
up_xml_name = 'BG-BF-UP0'
right_xml_name = 'BG-BF-RIGHT0'
...
name_of_character_xml = 'cosmic-bg-bf'
name_of_character = 'cosmic-bg-bf'
charNote = 'cosmicbg'
...
function onBeatHit()
    ...
    if curBeat == 80 then
        doTweenY("bfcosmicscale", name_of_character ..".scale", 1, 1, "cubeOut")
        doTweenX("bfcosmicscale2", name_of_character .. ".scale", 1, 1, "cubeOut")
    end
    if curBeat == 296 then
        doTweenY("bfcosmicscale", name_of_character ..".scale", 0, 1, "cubeOut")
        doTweenX("bfcosmicscale2", name_of_character .. ".scale", 1.5, 1, "cubeOut")
    end
